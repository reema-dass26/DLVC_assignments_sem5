    ...
    def __init__(self, num_classes):
        ...
        self.encoder = MixVisionTransformer(
            embed_dims=[
                ...
                160,
                256,
            ],  # the feature dimension of each of the 4 blocks
            ...
            mlp_ratios=[
                ...
                4,
                4,
            ],  # the ratio of how much to increase the hidden dim in the MLPs
            ...
            sr_ratios=[
                ...
                2,
                1,
            ],  # the ratios used for efficient attention in each block
            drop_rate=0.0,
            drop_path_rate=0.0,
        )
